...
public class sqlLib :MainClass
{
    ...
    public string ConnectionString
    {
        get
        {
            try { if (cnstr == "") { cnstr = ConnectionWin(); } }
            //RMaxCrypto.Crypto.Decrypt(WebConfigurationManager.ConnectionStrings["CnStr"].ConnectionString); } }
            catch { }
            return cnstr;
        }
        set
...
public class sqlLibPOS
{
   ...
   // private proLib plib = new proLib();
    ...
    public string ConnectionString
    {
        get
        {
            try { if (cnstr == "") { cnstr = RMaxCrypto.Crypto.Decrypt(WebConfigurationManager.ConnectionStrings["CnStrPOS"].ConnectionString); } }
            catch { }
            return cnstr;
        }
        set
