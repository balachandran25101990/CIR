...
public class dbLib : sqlLib
{
    ...
    public DataSet EmpAuthenticatePwd(string UId)
    {
        ProcedureName = "MRV_Employee";
    ...
    public DataSet MRSAttemptpassword(string UId)
    {
        ProcedureName = "MRS_Attemptpassword";
        AddParameter("UId", UId);
        return ExecuteProcedure;
    }
    #endregion
    ...
    public DataSet GetCategory(string Refid, string View, string Catid, string Uid)
    {
        ProcedureName = "MRG_category";
        AddParameter("Refid", Refid);
        AddParameter("View", View);
    ...
    public DataSet FetchFieldalertdoc(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "RPT_Fieldalertdoc";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
        AddParameter("Controlsearch", Controlsearch);
        AddParameter("Grp", Grp);
        AddParameter("UId", UId);
        return ExecuteProcedure;
    }
    ...
    public DataSet FetchSafetyAlert(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "RPT_SafetyAlert";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
    ...
    public DataSet FetchSWFWDocument(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "RPT_SWFWDocument";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
    ...
    public DataSet FetchCustomerInformationDoc(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "RPT_CustomerInformationDoc";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
    ...
    public DataSet FetchServiceBullet(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "Rpt_ServiceBullet";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
    ...
    public DataSet GetPageAccessDetails(string pageName, string UId)
    {
        ProcedureName = "MRG_PageAccess";
    ...
    public DataSet FetchChangenote(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "Rpt_changenote";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
    ...
    public DataSet FetchAlarmFAQ(string Genral, string Type, string Tagsearch, string Titlesearch, string Controlsearch, string Grp, string UId)
    {
        ProcedureName = "Rpt_AlarmFAQ";
        AddParameter("Genral", Genral);
        AddParameter("Type", Type);
        AddParameter("Tagsearch", Tagsearch);
        AddParameter("Titlesearch", Titlesearch);
